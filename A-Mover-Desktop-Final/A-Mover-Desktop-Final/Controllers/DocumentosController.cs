...
namespace A_Mover_Desktop_Final.Controllers
{
    public class DocumentosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IDDocumento,Nome")] Documento documento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IDDocumento,Nome")] Documento documento)
        {
